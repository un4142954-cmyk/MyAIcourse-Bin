...
df.plot.scatter(x='number_courses',y='Marks')
plt.show()
...
print("df['number_courses'] :    ",df['number_courses'])


print("df['Marks'] :  ",df['Marks'])
...
X = df['number_courses'].values.reshape(-1, 1)
